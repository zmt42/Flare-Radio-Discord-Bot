...
def getStat():
  page = requests.get("https://www.flareradio.net/soon/")
  soup = BeautifulSoup(page.text, 'html.parser')
  song = soup.find(class_='stats-song').get_text()
  artist = soup.find(class_='stats-artist').get_text()
  return song+" by "+artist

def getDJ():
  page = requests.get("https://www.flareradio.net/soon/")
  soup = BeautifulSoup(page.text, 'html.parser')
  dj = soup.find(class_='stats-dj').get_text()
  return dj
